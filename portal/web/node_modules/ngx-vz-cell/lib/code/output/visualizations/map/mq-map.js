const MQKEY = 'zD70qtcGlyGABcv03ieWmQTD7pnP6E2G';
const Key = 'zD70qtcGlyGABcv03ieWmQTD7pnP6E2G';
const MQCONFIGNUMBER = 1;
if (window.MQPROTOCOL === undefined) {
    var MQPROTOCOL = window.location.protocol === 'https:' ? 'https://' : 'http://';
}
const MQPLATFORMSERVER = MQPROTOCOL + "www.mapquestapi.com";
const MQSTATICSERVER = "https://www.mapquestapi.com/staticmap/";
const MQTRAFFSERVER = "https://www.mapquestapi.com/traffic/";
const TRAFFSERVER = "https://www.mapquestapi.com/traffic/";
const MQROUTEURL = "https://www.mapquestapi.com/directions/";
const MQGEOCODEURL = "https://www.mapquestapi.com/geocoding/";
const MQNOMINATIMURL = MQPROTOCOL + "open.mapquestapi.com/";
const MQSEARCHURL = "https://www.mapquestapi.com/search/";
const MQLONGURL = MQPLATFORMSERVER;
const MQSMSURL = MQPLATFORMSERVER;
const MQTOOLKIT_VERSION = "v2.2".replace(/^v/, '');
const MQIMAGEPATH = "https://api-s.mqcdn.com/" + "sdk/leaflet/v2.2/";
const MQCDN = "https://api-s.mqcdn.com/" + "sdk/leaflet/v2.2/";
const MQCDNCOMMON = "https://api-s.mqcdn.com/";
const MQICONSERVER = MQPROTOCOL + 'icons.mqcdn.com';
const ICONSERVER = MQPROTOCOL + 'icons.mqcdn.com';
const MQICONCDN = MQPROTOCOL + 'api.mqcdn.com';
const LOGSERVER = "https://www.mapquestapi.com";
const MQTILELOGGER = "https://www.mapquestapi.com";
const MQLOGURL = "https://www.mapquestapi.com/logger/v1";
const COVSERVER = "https://tileproxy.cloud.mapquest.com";
const MQCOPYRIGHT = "https://tileproxy.cloud.mapquest.com";
const MQCOPYRIGHT_PATH = "/attribution";
const MBMAP = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.streets/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBHYB = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.satellite/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBSAT = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.satellitenolabels/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBLIGHT = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.light/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBDARK = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.dark/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBMAP_OPEN = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.streets-mb/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBHYB_OPEN = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.satellite-mb/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBLIGHT_OPEN = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.light-mb/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBDARK_OPEN = "https://{$hostrange}.tiles.mapbox.com/v4/mapquest.dark-mb/{$z}/{$x}/{$y}.{$ext}?access_token=pk.eyJ1IjoibWFwcXVlc3QiLCJhIjoiY2Q2N2RlMmNhY2NiZTRkMzlmZjJmZDk0NWU0ZGJlNTMifQ.mPRiEubbajc6a5y9ISgydg";
const MBEXT = "png";
const MBTILEHI = "4";
const MBTILELO = "1";
const MBCOPYRIGHT = "https://tileproxy.cloud.mapquest.com";
const MBCOPYRIGHT_PATH = "/attribution";
...
MQ.TileLayer = L.TileLayer.extend({
    _config: {},
    options: { key: null, mapType: "map", ext: "png", attribution: "", maxZoom: 20, maxNativeZoom: 20 },
    ...
    _getFlags: function() {
        var C = { map: false, sat: false, hyb: false };
        if (this._map && this._map.mapquest) {
...
var boundaryDefinition = {
    ...
    features: [{
        type: "Feature",
        properties: { name: "Canada, USA, Mexico" },
        geometry: {
            type: "Polygon",
            coordinates: [
                [
        ...
        type: "Feature",
        properties: { name: "Puerto Rico", minZoom: 9 },
        geometry: {
            type: "Polygon",
            coordinates: [
                [
        ...
        type: "Feature",
        properties: { name: "South Florida", minZoom: 7 },
        geometry: {
            type: "Polygon",
            coordinates: [
                [
    ...
    doXhr: function(N, M, R) {
        ...
        var S = function() {
            ...
            if (B >= 200 && B <= 299) {
                ...
                R(C, { reason: "HTTP error", statusCode: B, responseText: E })
            }
        };
        O.onreadystatechange = function() {
            if (Q) {
    ...
    doGetJSON: function(D, F, E) {
        return this.doXhr(D, F, function(B, A) {
            if (A) {
                ...
                if (!C) {
                    E(false, { reason: "Parse Error", responseText: B.responseText })
                } else {
...
MQ.MapConfig = L.Class.extend({
    ...
    _hasLoaded: 0,
    sslMode: false,
    _config: { smallMap: 400, version: "1.0", hd: L.Browser.retina ? "@2x" : "" },
...
MQ.Control.Attribution = L.Control.extend({
    ...
    refreshAttribution: function() {
        ...
        var Q, O = [],
            ...
            U = null,
            S, W, Y = {},
            N = window.location.hostname.match(/.ca$/) ? "http://info.mapquest.com/mapquest-terms-of-use-ca-en/" : "http://hello.mapquest.com/terms-of-use";
        ...
        let termsHTML = '<a id="terms" class="termsLink" target="_blank" href="' + N + '">Terms</a>';
    ...
    refreshCoverage: function() {
        ...
        var I = { html_short: "", html: "&copy; Mapbox", text_short: "MB", text: "Mapbox", id: "mb" };
        var G = { html_short: "", html: "&copy; TomTom", text_short: "TT", text: "TomTom", id: "tt" };
        var K = { html_short: "", html: "&copy; OpenStreetMap", text_short: "OSM", text: "OpenStreetMap", id: "osm" };
...
var GROUP_SORT = { "": 1, "Map Data": 2, Imagery: 3 };
